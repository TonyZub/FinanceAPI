...
const PRELOADER_HTML = '<div class="d-flex justify-content-center min-vh-50"><div class="spinner-border align-self-center d-flex" role="status"><span class="visually-hidden">Loading...</span></div></div>';
